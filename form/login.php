...
<nav class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
    ...
    <a class="navbar-brand" href="../index.php"><strong><span style="color:red;font-family: 'Permanent Marker', cursive;">Food Hunt</span></strong></a>
...
<div class="middle" style=" padding:20px; border:1px solid #ED2553; margin:0px auto; width:500px;">
	   ...
	   <!--login Section-- starts-->
            <div class="tab-pane fade show active" id="login" role="tabpanel" aria-labelledby="home-tab">
			  ...
			  <form method="post" enctype="multipart/form-data">
                  ...
                  <a href="new-customer.php"><button type="button" name="new" class="btn btn-success">Create New Account</button></a>
	   ...
	   <div class="tab-pane fade" id="forgot" role="tabpanel" aria-labelledby="home-tab">
			  <form method="post" enctype="multipart/form-data">
                    ...
                    <!-- style="background:#ED2553; border:1px solid #ED2553;" -->
